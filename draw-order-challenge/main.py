...
class App(object):
    ...
    def update(self):
        ...
        # modified lines (next 3):
        sprites_list = self.all_sprites.sprites()
        sprites_list.sort(cmp=lambda f,s: cmp(f.rect.y, s.rect.y))
        self.all_sprites = pg.sprite.OrderedUpdates(sprites_list)
